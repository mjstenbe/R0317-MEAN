...
![HTTP-operaatiot ja niiden selitykset koodeineen \(https://www.restapitutorial.com/\)](.gitbook/assets/image%20%2823%29.png)
...
![Er&#xE4;&#xE4;n REST-rajapinnan kuvaus UML-muodossa \(L&#xE4;hde: https://firstinfinity.wordpress.com/modeling\_rest\_web\_services/\)](.gitbook/assets/image%20%2826%29.png)

## Luotavan rajapinnan hahmottelua

Hahmotellaan ensin luotava rajapinta reittien ja niissä käytettyjen verbien mukaan:

![Kuva: Luotavan rajapinnan hahmottelua.](.gitbook/assets/image%20%2835%29.png)
...
![Kuva: Ohjelman GET-reitin testausta selaimessa.](.gitbook/assets/image%20%2824%29.png)
...
![Kuva: API:n testausta Postmanilla](.gitbook/assets/image%20%2852%29.png)
...
![Kuva: POST-tyyppisen pyynn&#xF6;n l&#xE4;hett&#xE4;minen.](.gitbook/assets/image%20%2855%29.png)
...
![Kuva: DELETE-version testaamista Postmanilla.](.gitbook/assets/image%20%2857%29.png)

### PUT

Päivitysoperaatio suoriteaan PUT-verbillä ja testataan vielä sitäkin Postmanilla.

![Kuva: PUT-verbin testaaminen Postmanilla.](.gitbook/assets/image%20%2822%29.png)
...
![Kuva: Reitin testaaminen Postmanilla. ](.gitbook/assets/image%20%2843%29.png)
